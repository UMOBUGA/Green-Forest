...
public class HUD {
    ...
    public void draw(Graphics2D g2, int screenW, int screenH,
                     Player player, float gameTimeSec,
        ...
        g2.drawString("Nivel " + player.getLevel(), 12, 68);
        g2.setColor(new Color(200, 200, 200));
        g2.drawString("Kills: " + player.getKills(), 12, 84);
        ...
        if (bossImminent) {
            ...
            // Pisca mais rapido conforme o boss se aproxima
            ...
            if ((t / interval) % 2 == 0) {
                ...
                g2.drawString(warn,
                        screenW / 2 - fm.stringWidth(warn) / 2 + 1, 57);
                g2.setColor(new Color(255, 70, 70));
                g2.drawString(warn,
                        screenW / 2 - fm.stringWidth(warn) / 2, 56);
            }
        }
